...
CRITERION_COLUMN_WHITELIST = {
    ...
    "1_2_2": ["programName", "courseCode", "yearOffering", "timesOffered", "duration", "studentsEnrolled", "studentsCompleted"],
    "2_1": ["enrollment_year", "student_name", "enrollment_number", "enrollment_date"],
    "2_2": ["year", "category", "reserved_seats"],
    "2_1_1": ["year", "programCode", "programName", "seats_sanctioned", "students_admitted"],
    "2_1_2": ["year", "ear_sc", "ear_st", "ear_obc", "ear_gen", "ear_others", "adm_sc", "adm_st", "adm_obc", "adm_gen", "adm_others"],
    "2_3": ["passing_year", "studentName", "enrollmentNumber"],
    "2_3_3": ["academic_year", "branch", "first_year_count", "second_year_count", "third_year_count", "fourth_year_count", "total_students"],
    "2_4_1": ["department", "name", "pan", "designation", "year", "nature", "experience", "still_serving", "last_year_of_service"],
    "2_4_2": ["teacher_name", "qualification", "obtaining_year", "number_of_full_time_teachers"],
    "2_6_3": ["year", "program_code", "program_name", "appeared_count", "passed_count"],
    "3_1": ["teacherName", "id_number_aadhar", "email", "gender", "designation", "date_of_joining", "sanctioned_posts", "academic_year"],
    "3_2": ["year", "sanctioned_posts_count"],
    "3_1_1_2": ["project_name", "pi_name", "department", "year_of_award", "amount_sanctioned", "duration", "funding_agency", "funding_type"],
    "3_1_3": ["year", "event_name", "participant_count", "date_from_to"],
    "3_2_1": ["paper_title", "author_names", "department", "journal_name", "year_of_publication", "issn", "ugc_recognition_link"],
    "3_2_2": ["author_names", "book_title", "paper_title", "proceedings_title", "conference_name", "level", "year_of_publication", "isbn_issn", "affiliating_institute", "publisher"],
    "3_3_2": ["activity_name", "award_name", "awarding_body", "award_year"],
    "3_3_3_4": ["activity_name", "agency_name", "scheme_name", "year", "students_participated"],
    "3_4_1": ["activity_title", "agency_name", "participant_name", "year", "duration", "nature_of_activity"],
    "3_4_2": ["organisation_name", "institution_name", "signing_year", "duration", "activities_list", "participant_count"],
    "4_1_3": ["room_number", "ict_facility_type", "geo_tagged_photo_link"],
    "4_1_4": ["year", "budget_infra", "expenditure_infra", "total_expenditure_excl_salary", "expenditure_academic_maint", "expenditure_physical_maint"],
    "4_2_2": ["academic_year", "resource", "details", "exp_subscription", "exp_others", "total_exp"],
    "5_1_1": ["year", "scheme_name", "gov_student_count", "gov_amount", "inst_student_count", "inst_amount"],
    "5_1_3": ["program_name", "implementation_date", "students_enrolled", "agencies_involved"],
    "5_1_4": ["year", "exam_activity_name", "exam_students_count", "counseling_activity_name", "counseling_students_count", "students_placed"],
    "5_2_1": ["year", "studentName", "enrollmentNumber", "program_graduated", "employer_name", "employer_contact", "pay_package"],
    "5_2_2": ["student_name", "program_graduated", "inst_joined", "prog_joined"],
    "5_2_3": ["year", "registration_no", "student_name", "exam_qualified"],
    "5_3_1": ["year", "award_name", "event_level", "team_individual", "event_name", "student_name"],
    "5_3_3": ["event_date", "event_name", "student_name"],
    "6_2_3": ["areas_of_e_governance", "name_of_vendor_with_contact_details", "year_of_implementation"],
    "6_3_2": ["year", "name_of_teacher", "name_of_conference_workshop", "name_of_professional_body", "amount_of_support"],
    "6_3_3": ["dates_from_to", "title_of_professional_development_program", "title_of_administrative_training_program", "no_of_participants"],
    "6_3_4": ["name_of_teacher_who_attended", "title_of_the_program", "duration_from_to"],
    "6_4_2": ["year", "name_of_non_government_funding_agencies_individuals", "purpose_of_the_grant", "funds_grants_received_inr_in_lakhs", "link_to_audited_statement"],
    "6_5_3": ["year", "conferences_seminars_workshops_on_quality", "academic_administrative_audit_aaa", "participation_in_nirf", "nba_or_other_certification", "collaborative_quality_initiatives", "orientation_programme_on_quality_issues"],
}
...
_EXPORT_HEADERS = {
    ...
    # Criteria 3-6 extra headings
    "project_name": "Name of the Project / Endowments, Chairs",
    "pi_name": "Name of the Principal Investigator / Co-Investigator",
    "amount_sanctioned": "Amount Sanctioned (INR in Lakhs)",
    "funding_agency": "Name of the Funding Agency",
    "funding_type": "Type (Government / Non-Government)",
    "event_name": "Name of the Activity / Event",
    "participant_count": "Number of Participants",
    "date_from_to": "Date From - To",
    "paper_title": "Title of Paper",
    "author_names": "Name of the Author/s",
    "journal_name": "Name of Journal",
    "year_of_publication": "Year of Publication",
    "isbn_issn": "ISBN/ISSN Number",
    "proceedings_title": "Title of the Proceedings of the Conference",
    "conference_name": "Name of the Conference",
    "affiliating_institute": "Affiliating Institute at the Time of Publication",
    "publisher": "Name of the Publisher",
    "activity_name": "Name of the Activity",
    "award_name": "Name of the Award / Recognition",
    "awarding_body": "Awarding Body",
    "award_year": "Year of Award",
    "agency_name": "Organising Unit / Agency / Collaborating Agency",
    "scheme_name": "Name of the Scheme",
    "students_participated": "Number of Students Participated",
    "activity_title": "Title of the Collaborative Activity",
    "participant_name": "Name of the Participant",
    "nature_of_activity": "Nature of Activity",
    "organisation_name": "Organisation with which MoU is Signed",
    "institution_name": "Name of the Institution / Industry / Corporate House",
    "signing_year": "Year of Signing MoU",
    "activities_list": "List the Actual Activities under Each MOU Year Wise",
    "room_number": "Room Number / Name",
    "ict_facility_type": "Type of ICT Facility",
    "geo_tagged_photo_link": "Link to Geo-Tagged Photos / Timetable",
    "budget_infra": "Budget Allocated (INR in Lakhs)",
    "expenditure_infra": "Expenditure Augmentation (INR in Lakhs)",
    "total_expenditure_excl_salary": "Total Expenditure Excluding Salary (INR in Lakhs)",
    "expenditure_academic_maint": "Maintenance Expenditure on Academic Facilities (INR in Lakhs)",
    "expenditure_physical_maint": "Maintenance Expenditure on Physical Facilities (INR in Lakhs)",
    "resource": "Library Resource",
    "details": "Membership Details",
    "exp_subscription": "Expenditure on Subscription of e-Journals (INR in Lakhs)",
    "exp_others": "Expenditure on Subscription of Other e-Resources (INR in Lakhs)",
    "total_exp": "Total Library Expenditure (INR in Lakhs)",
    "gov_student_count": "Govt Scheme: Number of Students Benefited",
    "gov_amount": "Govt Scheme: Amount Benefited (INR)",
    "inst_student_count": "Institution Scheme: Number of Students Benefited",
    "inst_amount": "Institution Scheme: Amount Benefited (INR)",
    "program_name": "Name of the Capability Enhancement Program",
    "implementation_date": "Date of Implementation",
    "students_enrolled": "Number of Students Enrolled",
    "agencies_involved": "Name of the Agencies / Consultants Involved",
    "exam_activity_name": "Name of the Activity (Competitive Exams)",
    "exam_students_count": "Number of Students Attended (Competitive Exams)",
    "counseling_activity_name": "Details of Career Counseling Activity",
    "counseling_students_count": "Number of Students Attended (Career Counseling)",
    "students_placed": "Number of Students Placed Through Campus Placement",
    "employer_name": "Name of the Employer with Contact Details",
    "employer_contact": "Employer Contact Details",
    "pay_package": "Pay Package (INR)",
    "inst_joined": "Name of Institution Joined",
    "prog_joined": "Name of Programme Admitted To",
    "registration_no": "Registration Number / Roll Number for the Exam",
    "exam_qualified": "Exam Qualified",
    "event_level": "University/State/National/International Level",
    "team_individual": "Team / Individual",
    "event_date": "Date of Event/Activity (DD-MM-YYYY)",
    "areas_of_e_governance": "Areas of e-Governance",
    "name_of_vendor_with_contact_details": "Name of the Vendor with Contact Details",
    "year_of_implementation": "Year of Implementation",
    "name_of_teacher": "Name of the Teacher",
    "name_of_conference_workshop": "Name of the Conference / Workshop",
    "name_of_professional_body": "Name of the Professional Body",
    "amount_of_support": "Amount of Support (INR)",
    "dates_from_to": "Date From - To",
    "title_of_professional_development_program": "Title of the Professional Development Program",
    "title_of_administrative_training_program": "Title of the Administrative Training Program",
    "no_of_participants": "Number of Participants",
    "name_of_teacher_who_attended": "Name of Teacher Who Attended",
    "title_of_the_program": "Title of the Program",
    "duration_from_to": "Duration From - To",
    "name_of_non_government_funding_agencies_individuals": "Name of the Non-Government Funding Agencies / Individuals",
    "purpose_of_the_grant": "Purpose of the Grant",
    "funds_grants_received_inr_in_lakhs": "Funds / Grants Received (INR in Lakhs)",
    "link_to_audited_statement": "Link to Audited Statement",
    "conferences_seminars_workshops_on_quality": "Conferences, Seminars, Workshops on Quality Conducted",
    "academic_administrative_audit_aaa": "Academic Administrative Audit (AAA) Status",
    "participation_in_nirf": "Participation in NIRF Status",
    "nba_or_other_certification": "NBA or Other Quality Certification Status",
    "collaborative_quality_initiatives": "Collaborative Quality Initiatives",
    "orientation_programme_on_quality_issues": "Orientation Programme on Quality Issues",
}
