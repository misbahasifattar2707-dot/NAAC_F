    ...
    <div className="app-layout">
      ...
      <div className="main-content">
        <header className="page-header">
          ...
          <button className="btn btn-success btn-sm fw-semibold" onClick={() => window.open(getExcelExportUrl('3_1_1_2'), '_blank')}>
                  ...
                  <div className="row g-3 mb-3">
                    {COLS.map(({ key, label, col }) => (
                      <div className={col} key={key}>
                        ...
                        {key === "funding_type" ? (
                          <select className="form-select" value={form[key]} onChange={e => handleChange(key, e.target.value)}>
            ...
            <div className="table-responsive">
              <table className="table table-hover align-middle mb-0">
                ...
                <tbody>
                  ...
                  <CriterionProofFileSection criterionKey="3_1_1_2" />
        <Footer />
      </div>
                ...
                <div className="row g-3">
                  {COLS.map(({ key, label, col }) => (
                    <div className={col} key={key}>
                      ...
                      {key === "funding_type" ? (
                        <select className="form-select" value={editRecord[key] || ""} onChange={e => setEditRecord({ ...editRecord, [key]: e.target.value })}>
                          <option value="">Select Type</option>
                          <option value="Government">Government</option>
                          <option value="Non-Government">Non-Government</option>
                        </select>
